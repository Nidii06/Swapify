...
<body>
  ...
  <main class="container">
      ...
      <div class="slider-container">
        <div class="slide active">
          <div class="slide-content">
            ...
            <a href="contact.php" class="btn btn-primary btn-lg">Swapify</a>
          </div>
        </div>
        <div class="slide">
          <div class="slide-content">
    ...
    <section class="popular-skills">
      ...
      <?php else: ?>
        <div class="home-categories-flexbox">
          ...
          <div class="home-category-card">
            ...
            <div class="home-category-content">
              ...
              <a href="register.php?category=<?= $category['id'] ?>" class="home-category-link">
        ...
        <div class="view-all-skills">
          <a href="contact.php" class="btn btn-primary btn-lg">
            <i class="fas fa-search"></i>Contact Us
          </a>
        </div>
      <?php endif; ?>
    </section>
